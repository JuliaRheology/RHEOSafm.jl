...
plot(data.ϵ, data.σ, legend = false, xlabel = "Strain", ylabel = "Stress", guidefont= 10, size = (300,300), label = "Original data", lw=3, margin=8mm)
...
plot(data_contact.ϵ, data_contact.σ, legend = false, xlabel = "Strain", ylabel = "Stress", guidefont= 10, size = (300,300), label = "Shifted data", lw=3, margin=8mm)
...
plot(data_contact.ϵ, data_contact.σ, legend = true, xlabel = "Stress", ylabel = "Stress", label = "Experimental data", guidefont= 10, size = (500,500), lw=3, margin=8mm)
