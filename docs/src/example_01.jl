...
plot(data.t, data.σ, legend = false, xlabel = "Time", ylabel = "Stress", guidefont= 10, size = (300,300), lw=3, margin=8mm)
...
plot(data_contact.t, data_contact.σ, legend = true, xlabel = "Time", ylabel = "Stress", label = "Experimental data", guidefont= 10, size = (500,500), lw=3, margin=8mm)
