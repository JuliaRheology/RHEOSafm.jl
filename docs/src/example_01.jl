...
plot(data.t, data.σ, legend = false, xlabel = "Time", ylabel = "Stress", guidefont= 10, size = (400,400), lw=3)
...
plot(data_contact.t, data_contact.σ, legend = true, xlabel = "Time", ylabel = "Stress", label = "Experimental data", guidefont= 10, size = (400,400), lw=3)
plot!(SLS_predict.t, SLS_predict.σ, label = "Predicted",guidefont= 10, size = (400,400), lw=2)
